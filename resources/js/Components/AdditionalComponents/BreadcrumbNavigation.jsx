...
const BreadcrumbNavigation = ({ steps, currentStep, onStepClick, stepHasData }) => {
    return (
        <nav className="w-full p-3">
            <ol className="flex flex-wrap items-start gap-2 m-0">
                {steps.map((step, index) => {
                  ...
                  ${!isActive && !isFuture ? 'hover:bg-opacity-80' : 'bg-gray-200 text-gray-400'}
...
const BreadcrumbNavigation2 = ({ steps, currentStep, onStepClick, stepHasData }) => {
    return (
        <nav className="w-full p-3">
            <ol className="flex flex-wrap items-start gap-2 m-0">
                {steps.map((step, index) => {
