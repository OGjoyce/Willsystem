...
const Article = React.forwardRef((props, ref) => (
    ...
    <div ref={ref}>
        <><center><strong>LAST WILL AND TESTAMENT OF CARLOS MONTIEL </strong></center><p><br /><br /> I, CARLOS MONTIEL, presently of toronto, Ontario, declare that this is my Last Will and
        Testament.<br /><br /></p><center><strong>I. PRELIMINARY DECLARATIONS</strong></center><p><strong><u>Prior Wills and Codicils</u></strong></p><ol>
            ...
            <ol>
                <li>I appoint JOHN DOE of Toronto, ON as the sole Executor of this my Will.</li>
                <li>If JOHN DOE should refuse or be unable to act or continue to act as my Executor, then I appoint william Doe
                    of mississauga, ON to be the sole Executor of this my Will.</li>
                <li>If william Doe of mississauga, ON should refuse or be unable to act or continue to act as my Executor, then
            ...
            <ol>
                ...
                <li>I leave Motorcycle - Harley to JOHN DOE of Toronto, ON if they shall survive me, for their own use
                    absolutely.</li>
                <li>I leave gold chain to KATIE DOE of toronto, on if they shall survive me, for their own use absolutely.</li>
            </ol>
