...
const PaymentModal = ({ show, handleClose }) => {
    ...
    const [showStripePayment, setShowStripePayment] = useState(false); // Estado para mostrar Stripe
    ...
    const handleConfirm = () => {
        if (selectedOption) {
            ...
            if (selectedOption.label === 'Stripe') {
                // Mostrar el componente de Stripe
                setShowStripePayment(true);
            } else {
                handleClose();
                // Lógica para otros métodos de pago
                console.log(`Handle payment for ${selectedOption.label}`);
            }
        }
    };
